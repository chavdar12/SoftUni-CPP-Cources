...
int main()
{
    ...
    if (type == 'i')
    {
        ...
        int n;
        using Set = std::set<int, Reverse<int, LessThan<int>>>;
        Set numbers;
        while (p.readNext(n))
        {
            numbers.insert(n);
    ...
    else if (type == 'w')
    {
        ...
        std::string w;
        using Set = std::set<std::string, Reverse<std::string, LessThan<std::string>>>;
        Set words;
        while (p.readNext(w))
        {
            words.insert(w);
    ...
    else if (type == 's')
    {
        ...
        Song s;
        using Set = std::set<Song, Reverse<Song, LessThan<Song>>>;
        Set songs;
        while (p.readNext(s))
        {
            songs.insert(s);
